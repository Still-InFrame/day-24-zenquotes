...
# Exclude this script itself: its PATTERNS definition above contains the literal
# token strings (SERVICE_ROLE, sk-, BEGIN PRIVATE KEY...) and would self-match.
# betterleaks below still scans publish.sh, so it stays covered by the broad engine.
